...
VISIT_FORWARDING_SECRET = os.environ.get("VISIT_FORWARDING_SECRET", "")
VISIT_RETENTION_DAYS = int(os.environ.get("VISIT_RETENTION_DAYS", "30"))
VISIT_FORWARDING_MAX_AGE_SECONDS = int(os.environ.get("VISIT_FORWARDING_MAX_AGE_SECONDS", "60"))
VISIT_CLEANUP_BATCH_SIZE = int(os.environ.get("VISIT_CLEANUP_BATCH_SIZE", "500"))
if VISIT_RETENTION_DAYS <= 0 or VISIT_CLEANUP_BATCH_SIZE <= 0 or VISIT_FORWARDING_MAX_AGE_SECONDS <= 0:
    raise ValueError("VISIT_RETENTION_DAYS, VISIT_CLEANUP_BATCH_SIZE and VISIT_FORWARDING_MAX_AGE_SECONDS must be positive")
